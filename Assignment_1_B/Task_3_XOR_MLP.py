...
training_graph = topological_sort(loss_node)
trainables = [node for node in training_graph if isinstance(node, Parameter)]
...
forward_pass([input_node, w1, b1, layer1, activation1, w2, b2, layer2, activation2, w3, b3, output_layer, output_activation])
